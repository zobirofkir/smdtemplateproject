        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    <span class="wow fadeInDown" data-wow-delay=".2s">Équipe</span>
                    <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Rencontrez nos Médecins</h2>
            ...
            <div class="row team-active">
                                    ...
                                    <g id="noun_Stomach_5760092" transform="translate(-4.423 -0.572)">
                                        <g id="Group_1522" data-name="Group 152" transform="translate(4.423 0.572)">
                                            <path id="Path_70" data-name="Path 70"
                                                ...
                                                transform="translate(-4.423 -0.572)" fill="#fff" />
                                            <path id="Path_711" data-name="Path 71"
                                                ...
                                                transform="translate(-5.596 -3.409)" fill="#fff" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            ...
                            <div class="specialist">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 57.792 58.716">
                                    ...
                                    <g id="noun_Brain_25815533" transform="translate(-5.696 -4.966)">
                                        <path id="Path_666" data-name="Path 66"
                                            d="M71.522,37.625a86.253,86.253,0,0,1-4.365-8.273,23.669,23.669,0,0,0-1.368-12.768C63.184,10.2,55.106,5.444,46.051,4.988a22.5,22.5,0,0,0-16.09,5.733.91.91,0,0,0-.2.977.928.928,0,0,0,.847.586h.912a4.536,4.536,0,0,1,1.629.326.819.819,0,0,0,.847-.13A18.391,18.391,0,0,1,45.855,8.9c7.426.326,14.266,4.169,16.286,9.055a19.834,19.834,0,0,1,1.173,10.683V28.7c0,.13-.065.2-.065.261-.065.586-.2,1.629,4.1,9.25h-.586a4.465,4.465,0,0,0-4.625,4.43v9.315a.764.764,0,0,1-.326.717c-1.368,1.107-5.215-2.98-2.177-2.98h.872a2.732,2.732,0,0,1,2.09-.09c1.477-1.045.592-.413-.248-.085Z"
                                            transform="translate(-5.696 -4.966)" fill="#fff" />
                                    </g>
                                </svg>
                            </div>
                        </div>
                        <div class="team-info">
                            <h5><a href="#">Dr: Fadima Kahlil.</a></h5>
                ...
                <div class="col-xl-3 col-lg-3">
                    <div class="single-team text-center mb-85">
                        <div class="team-img mb-50">
                            ...
                            <div class="specialist">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 51.275 58.44">
                                    ...
                                    <g id="noun_Stomach_5760092" transform="translate(-4.423 -0.572)">
                                        <path id="Path_70" data-name="Path 70"
                                            d="M53.065,18.13A8.5,8.5,0,0,0,46.853,13.3l-.016,0a4.4,4.4,0,0,1-3.089-2.131c-.217-.38-.417-.76-.592-1.143a11.73,11.73,0,0,1-.965-6.237,2.867,2.867,0,0,0-5.69-.7,17.283,17.283,0,0,0,1.446,9.331l.014.031c1.392,3.02-1,6.211-1.718,9.108a22.519,22.519,0,0,1-3.734,7.887,25.8,25.8,0,0,1-14.583,9.684l-.107.025a7.8,7.8,0,0,0-4.689,3.13,7.238,7.238,0,0,1-2.2,2.062A13.119,13.119,0,0,0,7.691,47.1a13.667,13.667,0,0,0-3.263,9.124,2.866,2.866,0,0,0,2.862,2.785l.082,0a2.867,2.867,0,0,0,2.785-2.946,7.737,7.737,0,0,1,1.451-4.7.982.982,0,0,1,1.589,0,7.79,7.79,0,0,0,2.5,2.149,27.063,27.063,0,0,0,12.968,3.309c.136,0,.273,0,.409,0A27.048,27.048,0,0,0,53.065,18.13Z"
                                            transform="translate(-4.423 -0.572)" fill="#fff" />
                                    </g>
                                </svg>
                            </div>
                        ...
                        <div class="team-info">
                            <h5><a href="#">Dr: Abdelaziz Marouf.</a></h5>
                            <span>Pédiatre</span>
                        </div>
                    </div>
                </div>
