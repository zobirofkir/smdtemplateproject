        ...
        <div class="row">
            <div class="col-xl-6 mx-auto">
                <div class="section-title text-center mb-25">
                    <span class="wow fadeInDown" data-wow-delay=".2s">Témoignage</span>
                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Ce que disent nos patients</h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div id="customize_wrapper">
                    <div class="customize testimonial-active" id="customize">
                        <div class="single-testimonial">
                            ...
                            <div class="testimonial-content">
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                    dinonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.Lorem
                                    ipsum dolor sit amet, consetetur sadipscing elitr, sed dinonumy.</p>
                            </div>
                            <div class="testimonial-info">
                                <h5>Numad Maoe.</h5>
                                <span>Fondateur de l'entreprise</span>
                            </div>
                        </div>
                        <div class="single-testimonial">
                            <div class="quote-icon">
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="testimonial-info">
                                <h5>Tulshi Das.</h5>
                                <span>Responsable du Design</span>
                            </div>
                        </div>
                        <div class="single-testimonial">
                            <div class="quote-icon">
