            ...
            <div class="col-xl-10 col-lg-11 mx-auto">
                <div class="about-content text-center mb-55">
                    <div class="section-title mb-30">
                        ...
                        <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Bienvenue dans notre clinique</h2>
                    </div>
                    ...
                    <a href="#" class="btn theme-btn wow fadeInUp" data-wow-delay=".8s">En savoir plus</a>
                </div>
            </div>
        </div>
    </div>
