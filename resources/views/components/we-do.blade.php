        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    <span class="wow fadeInDown" data-wow-delay=".2s">Ce que nous faisons</span>
                    <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Ce que nous offrons pour votre santé</h2>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="40.839" height="48.598" viewBox="0 0 40.839 48.598">
                                <g id="we-do-1" transform="translate(-12.184 -5)">
                                    <path id="Path_48" data-name="Path 48"
                                        ...
                                        transform="translate(0 -20.782)" fill="#8fd2ff" />
                                    <g id="Group_129" data-name="Group 129" transform="translate(38.284 37.747)">
                                        <g id="Group_128" data-name="Group 128">
                                            <path id="Path_49" data-name="Path 49"
                                                ...
                                                transform="translate(-60.52 -65.645)" fill="#8fd2ff" />
                                        </g>
                                    </g>
                                    <path id="Path_50" data-name="Path 50"
                                        ...
                                        transform="translate(-8.746 -5.917)" fill="#8fd2ff" />
                                    <path id="Path_51" data-name="Path 51"
                                        d="M50.512,14.093H32.943a.922.922,0,0,1-.922-.921C32.021,8.207,35.831,5,41.728,5s9.707,3.207,9.707,8.171A.922.922,0,0,1,50.512,14.093ZM41.728,6.746a7.428,7.428,0,0,0-7.425,7.425.923.923,0,0,1-.922.922,7.351,7.351,0,0,0,6.986,7.225h.019a7.348,7.348,0,0,0,7.358-7.225A.923.923,0,0,1,50.512,7.671C49.406,6.746,47.993,6.746,41.728,6.746Z"
                                        transform="translate(-5.133 0)" fill="#8fd2ff" />
                                </g>
                            </svg>
                        </div>
                        <h4 class="we-do-title mb-25">Consultations {{ $item }}</h4>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed di_nonumy eirmod tempor invidunt</p>
                    </div>
                </div>
