    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Nos Services de Santé</h2>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="service-item mb-30">
                                ...
                                <g id="Layer_2" data-name="Layer 2" transform="translate(0 -0.005)">
                                    <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)">
                                        <path id="Path_64" data-name="Path 64"
                                            ...
                                            transform="translate(-1.552 0.005)" fill="#8fd2ff" />
                                        <path id="Path_65" data-name="Path 65"
                                            ...
                                            transform="translate(0 -3.455)" fill="#8fd2ff" />
                                    </g>
                                </g>
                            </g>
                        </svg>
                    ...
                    <div class="service-content">
                        ...
                        <a href="#" class="read-more">En savoir plus <i class="lni lni-arrow-right"></i></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item mb-30">
                    <div class="service-icon mb-25">
                        <svg xmlns="http://www.w3.org/2000/svg" width="58.716" height="58.716" viewBox="0 0 58.716 58.716">
                            <g id="noun_Medicine_2322519" transform="translate(-2.988 -3.494)">
                                <path id="Path_68" data-name="Path 68"
                                    d="M47.047,44.773a5.951,5.951,0,1,1,4.063-9.964,5.94,5.94,0,0,1,1.726,3.3c-.212-.091-.517.031-.726.097l-.221-.091a2.757,2.757,0,0,0-.81-1.447l-.148-.16c-.346-.548-.71-1.084-.782-1.72a5.885,5.885,0,0,0-2.6-4.054l-.426-.094-.031-.179c-1.46-8.325-5.616-15.313-11.674-22.139-.489-3.174-2.895-5.888-5.651-7.522,4.179-5.352,2.739-11.887-2.1-16.428,5.7-.013,5.7-.015,5.7.156.243-2.46.525-3.79,1.59-.998,8.038,.152,.0913t....a-.76z"
                                />
                            </g>
                        </svg>
                    </div>
